...
?>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <h1 class="text-center">Excluir um produto</h1>
            ...
            <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                  ...
                  <?php foreach($cp->Consultar_produto_em_estoque() as $dados){?>
                            <tr>
                            <form method="post" action="modelo/excluir_produto.php">
                              ...
                              <td><button type="submit" class="btn btn-outline-danger btn-sm" name="btn_exclui"><i class="fa fa-crosshairs"></i></button></td>
                            </form>
                            </tr>
